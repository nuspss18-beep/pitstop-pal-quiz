const START_IMAGE = "Event Tele Post.png";
...
const pals = {
  ...
  sky: {
    ...
    tip: "Aim to sleep 20–30 minutes earlier tonight."
  },
  tobi: {
    short: "Tobi",
    name: "Tobi — Timeout",
...
const questions = [
  ...
  },
  {
    ...
    a: [
      {
        text: "Calmly clarify roles, expectations, and priorities.",
        pal: "perry",
        points: 1
      },
      {
        text: "Make space so everyone feels heard first.",
        pal: "iggy",
        points: 1
      }
    ]
  },
  {
    ...
    a: [
      {
        text: "Phone down. Protect tomorrow by sleeping now.",
        pal: "sky",
        points: 1
      },
      {
        text: "Search for a few more encouraging quotes before sleeping.",
        pal: "iggy",
        points: 1
      }
    ]
  },
  {
    ...
    a: [
      {
        text: "Enjoy a quiet solo hobby.",
        pal: "tobi",
        points: 1
      },
      {
        text: "Explore a new walking path on campus.",
        pal: "ola",
        points: 1
      }
    ]
  },
  {
    ...
    a: [
      {
        text: "Reconnect to your bigger purpose.",
        pal: "ping",
        points: 1
      },
      {
        text: "Set one tiny achievable goal and start.",
        pal: "perry",
        points: 1
      }
    ]
  },
  {
    ...
    a: [
      {
        text: "Reach out and talk about life or have a deep conversation with your friends.",
        pal: "ping",
        points: 1
      },
      {
        text: "Journal privately and sit with your thoughts.",
        pal: "tobi",
        points: 1
      }
    ]
  },
  {
    ...
    a: [
      {
        text: "Scheduling small breaks intentionally.",
        pal: "tobi",
        points: 1
      },
      {
        text: "Planning balanced meals and water intake.",
        pal: "ty",
        points: 1
      }
    ]
  },
  {
    ...
    a: [
      {
        text: "Give yourself a good rest as your reward.",
        pal: "sky",
        points: 1
      },
      {
        text: "Treat yourself to a luxurious meal.",
        pal: "ty",
        points: 1
      }
    ]
